<?php
 ...
 /*  $gambar=""; */
  ...
  if($_SERVER["REQUEST_METHOD"]=='GET'){
    ...
    $id = $_GET['id'];
    $sql_edit = "select * from pengguna where id=$id";
    ...
    $sql_edit = "update pengguna set username='$username', password='$password' where id='$id'";
    $result_edit = $koneksi->query($sql_edit);
...
<html lang="en">
  ...
  <body>
    ...
    <h1 class="text-white text-center">Akun Edit</h1>
    </div>
    ...
    <button class="btn btn-success" type="submit" href="admin.php" name="submit">Submit</button><br>
