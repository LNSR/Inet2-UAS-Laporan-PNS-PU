...
<head>
    ...
    <title>Sign Up | Pekerjaan Umum</title>
    <!-- Icon PU -->
    <link rel="icon" href="../assets/dist/img/Logo_PU_(RGB).jpg">
    <!-- Bootstrap CSS -->
    ...
    <div class="container">
        <div class="row content">
            ...
            <div class="col-md-6" style="margin-top: -30px;">
                <a class="btn logo" href="../index.php">Pekerjaan Umum</a>
                <img src="../assets/dist/img/Logo_PU_(RGB).jpg" width="40" height="40">
                <p class="lead">Dinas Kementerian Pekerjaan Umum</p>
                ...
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="username" id="username" required>
                            <?php
                            for ($i = 1; $i <= 5; $i++) {
                                echo "<option value='" . htmlspecialchars("tim $i", ENT_QUOTES) . "'>" . htmlspecialchars("tim $i", ENT_QUOTES) . "</option>";
                            }
                            ?>
                        </select>
                    </div>
