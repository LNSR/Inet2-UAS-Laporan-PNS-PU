...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
            ...
            <table class="table table-hover" id="table" width="100%">
              ...
              <tbody align="center">
                ...
                <tr>
                  ...
                  <td><?= $d['ket']; ?></td>
                  <td><?= $d['tgl_lapor']; ?></td>
                  <td><a href="detail-pengajuan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-outline-info mr-2" style="font-size: 15px; width: 80px;"><i class="fas fa-search mr-1"></i>Detail</a>
                      <a href="delete-pengajuan.php?id=<?= $d['id']; ?>" class="btn btn-sm btn-outline-danger" style="font-size: 15px; width: 80px;"><i class="fas fa-trash-alt mr-1"></i>Delete</a>
                  </td>
                </tr>
                <?php
                endforeach;
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-hourglass-half mr-3"></i>Sedang dikerjakan</h3>
          <div class="card-tools">
            <button type="button" class="btn btn-tool" data-card-widget="collapse" title="Collapse">
              <i class="fas fa-minus"></i>
            </button>
