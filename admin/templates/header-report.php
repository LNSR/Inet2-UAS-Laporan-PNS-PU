...
<head>
  ...
  <title>Report Data Proyek</title>
...
<div class="wrapper">
  ...
  <!-- /.navbar -->
    ...
    <a href="index.php" class="brand-link">
      <img src="../assets/dist/img/Logo_PU_(RGB).jpg" alt="Pekerjaan-Umum" class="brand-image img-circle elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light" style="font-size: 19px;">Dashboard</span>
    </a>
