  ...
  <div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-header">
          <h3 class="card-title"><i class="fas fa-book mr-3"></i>Data Proyek</h3>
          ...
          <div class="table-responsive">
            <table class="table table-hover" id="table-report" width="100%">
              ...
              <tbody align="center">
                ...
                $month = $_POST['month'];
                $year = $_POST['year'];
                $data = query("SELECT * FROM Pengajuan WHERE MONTH(tgl_lapor)='$month' AND YEAR(tgl_lapor)='$year' ORDER BY tgl_lapor DESC");
                foreach ($data as $d) :
                ?>
                <tr>
                  <td><?= $d['id']; ?></td>
