...
if (isset($_POST['submit'])) {
  if (updatepengajuan($_POST) > 0) {
    echo "<script>alert('Update data successfully!'); window.location='data-pengajuan.php';</script>";
    } else {
        echo "<script>alert('Data update gagal or tidak ada perubahan'); window.location='data-pengajuan.php';</script>";
    }
  }

$id = $_GET['id'];
$data = query("SELECT * FROM Pengajuan WHERE id = '$id'");
foreach ($data as $d) :
            ...
            <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <input type="text" name="np" id="np" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['n_pegawai']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="jp">Jabatan :</label>
                  <input type="text" name="jp" id="jp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['j_pegawai']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-4">
                  <label for="dp">Departemen :</label>
                  <input type="text" name="dp" id="dp" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['d_pegawai']; ?>" readonly>
                </div>
                <div class="col-md-4">
                  <label for="nb">Proyek :</label>
                  <input type="text" name="nb" id="nb" class="form-control mb-3 bg-transparent" style="cursor: default;" value="<?= $d['n_proyek']; ?>" readonly>
                </div>
              </div>
              <div class="row">
                <div class="col-md-8">
              ...
              <div class="row">
                <div class="col-md-4" style="border: 1px solid #ced4da; border-radius: 5px; margin: 7px 7px; padding: 7px 10px;">
                  ...
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Sedang dikerjakan" id="opt2" name="status" class="custom-control-input">
                    <label class="custom-control-label" for="opt2">Sedang dikerjakan</label>
                  </div>
                  <div class="custom-control custom-radio custom-control-inline">
                    <input type="radio" value="Selesai dikerjakan" id="opt3" name="status" class="custom-control-input">
                    <label class="custom-control-label" for="opt3">Selesai dikerjakan</label>
                  </div>
                    <?php
                    ...
                    ?>
                      ...
                      <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" value="Sedang dikerjakan" id="opt2" name="status" class="custom-control-input" checked>
                        <label class="custom-control-label" for="opt2">Sedang dikerjakan</label>
                      </div>
                      <div class="custom-control custom-radio custom-control-inline">
                        <input type="radio" value="Selesai dikerjakan" id="opt3" name="status" class="custom-control-input">
                        ...
                        ?>
                          ...
                          <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" value="Selesai dikerjakan" id="opt3" name="status" class="custom-control-input" checked>
                            <label class="custom-control-label" for="opt3">Selesai dikerjakan</label>
                          </div>
                        <?php
                        }
